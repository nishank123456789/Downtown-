function openDetails(itemId) {
    const details = {
        'starter-1': { name: 'Starter 1', description: 'Description of Starter 1 <br><img src="/images_starters/starter1.jpg" height="60%" width="60%" alt="image of starter 1 not available"</img><br><hr>', price: 'Rs 100' },
